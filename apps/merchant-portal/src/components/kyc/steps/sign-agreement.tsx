...
const mdComponents = {
  ...
  ul: ({ children, ...props }: React.ComponentProps<'ul'>) => <ul className="list-disc list-inside mb-1.5 text-xs text-muted-foreground" {...props}>{children}</ul>,
  ol: ({ children, ...props }: React.ComponentProps<'ol'>) => <ol className="list-decimal list-inside mb-1.5 text-xs text-muted-foreground" {...props}>{children}</ol>,
